...
public class Method3 {
	 ...
	 * argument/parameter: int ge, int salary
	 * return value:--
	 */
	public static void printDetails(int age, int salary) {//int age=25; int salary=56000;
		...
		//return;//optional because if you don't write it dn java compiler will write it(i.e.'void'is here therefore return value likhna optinal hai)
